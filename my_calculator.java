...
class my_frame extends JFrame implements ActionListener
{
	...
	{	
		...
		ImageIcon icon4=new ImageIcon("C:/jdk-9/bin/graphics/calculator/t2.png");
		ImageIcon icon5=new ImageIcon("C:/jdk-9/bin/graphics/calculator/t3.png");
	...
	public  void actionPerformed(ActionEvent e)
	{
		...
		if(b2==e.getSource())
		{
			my_frame2 frame1= new my_frame2();
		}
		if(b3==e.getSource())
		{
			my_frame3 frame1= new my_frame3();
		}
	}
}
...
class my_frame1 extends JFrame implements ActionListener
{
	...
	{	
		...
		ImageIcon ico=new ImageIcon("C:/jdk-9/bin/graphics/calculator/left-arrow.png");
		b19=new JButton(ico);
		b19.setVisible(true);
		b19.setEnabled(true);
		b19.setBackground(Color.YELLOW);
		b19.setBounds(10,10,ico.getIconHeight(),ico.getIconWidth());
		c.add(b19);
...
class my_frame2 extends JFrame implements ActionListener
{
	Container c;
	JLabel label1,label2,label3;
	ImageIcon icon1,icon2,icon3,icon4,icon5;
	...
	{	
		...
		color1=new Color(46,0,0);
		c.setBackground(color1);
		
		tf1=new JTextField("0");
		tf1.setBounds(30,50,330,70);
		color2=new Color(29,9,52);
		tf1.setBackground(Color.BLACK);
		tf1.setForeground(Color.PINK);
		tf1.setHorizontalAlignment(JTextField.RIGHT);
		Font f1=new Font("Lucida Bright",Font.BOLD,50);
		tf1.setFont(f1);
		tf1.setEditable(false);
		...
		color3=new Color(255, 218, 121);
		color4=new Color(19, 15, 64);
		Color color5=new Color(241, 144, 102);
		Font f2=new Font("Lucida Bright",Font.BOLD,30);
		...
		b11.setVisible(true);
		b11.setEnabled(true);
		b11.setForeground(color1);
		b11.setBackground(color5);
		b11.setBounds(360,50,90,70);
		Font f3=new Font("Lucida Bright",Font.BOLD,20);
		b11.setFont(f3);
		c.add(b11);
		...
		b18.setVisible(true);
		b18.setEnabled(true);
		b18.setForeground(color1);
		b18.setBackground(color5);
		b18.setBounds(360,470,90,70);
		b18.setFont(f2);
		c.add(b18);
...
class my_frame3 extends JFrame implements ActionListener
{
	Container c;
	JLabel label1,label2,label3;
	ImageIcon icon1,icon2,icon3,icon4,icon5;
	...
	{	
		...
		b12.setBackground(color5);
		b12.setBounds(377,250,70,70);
		b12.setFont(f2);
		c.add(b12);
		...
		b13.setBackground(color5);
		b13.setBounds(377,350,70,70);
		b13.setFont(f2);
		c.add(b13);
		...
		b14.setBackground(color5);
		b14.setBounds(255,150,70,70);
		b14.setFont(f3);
		c.add(b14);
		...
		b15.setBackground(color5);
		b15.setBounds(377,150,70,70);
		b15.setFont(f2);
		c.add(b15);
		...
		b16.setBackground(color5);
		b16.setBounds(377,450,70,70);
		b16.setFont(f2);
		c.add(b16);
